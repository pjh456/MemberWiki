...
├── architecture/
│   └── README.md                 # 系统架构与关键业务流说明
├── database/
│   ├── README.md                 # 数据库文档总览
│   ├── schema.md                 # 核心表结构与字段说明
│   ├── er-diagram.md             # ER 关系说明（文字版）
...
3. 然后读系统架构：`architecture/README.md`
4. 后端先读数据库与迁移：`database/README.md`、`database/schema.md`、`database/migration.md`
5. 前后端联调按 API 文档：`api/README.md` 与 `api/openapi.yaml`
